...
from src.models.cen_news_rec.news_encoder import NewsEncoder
from src.models.cen_news_rec.user_encoder import UserEncoder
from src.models.components.click_predictors import DotProduct
from src.models.components.losses import SupConLoss


class CenNewsRecModule(LightningModule):
    def __init__(
            self,
            supcon_loss: bool,
            late_fusion: bool,
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(root / "configs" / "model" / "cen_news_rec.yaml")
