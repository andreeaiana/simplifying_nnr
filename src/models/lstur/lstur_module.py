...
from src.models.lstur.news_encoder import NewsEncoder
from src.models.lstur.user_encoder import UserEncoder
from src.models.components.click_predictors import DotProduct
from src.models.components.losses import SupConLoss


class LSTURModule(LightningModule):
    def __init__(
            self,
            supcon_loss: bool,
            late_fusion: bool,
        ...
        if not self.hparams.late_fusion:
            ...
            self.user_encoder = UserEncoder(
                    ...
                    input_dim_multiplier=len(self.hparams.dataset_attributes),
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(root / "configs" / "model" / "lstur.yaml")
