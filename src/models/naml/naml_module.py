...
from src.models.naml.news_encoder import NewsEncoder
from src.models.naml.user_encoder import UserEncoder
from src.models.components.click_predictors import DotProduct
from src.models.components.losses import SupConLoss


class NAMLModule(LightningModule):
    def __init__(
            self,
            supcon_loss: bool,
            late_fusion: bool,
        ...
        pretrained_word_embeddings = torch.from_numpy(np.load(self.hparams.pretrained_word_embeddings_path)).float().to(self.device)
